...
if (isset($_POST['titre'])) {
    ...
    $film = new Films(null, $_POST['titre'], $_POST['realisateur'], $_POST['affiche'], $_POST['annee'], /*placer le tabRole*/);
    ...
    if ($status) {
        echo $twig->render('creer_film.html.twig', ['status' => "Le film à été ajouté", 'film' => $film]);
    }
